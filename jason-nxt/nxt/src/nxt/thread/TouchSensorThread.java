...
public class TouchSensorThread extends SensorThread {

	TouchSensor sensor;
	boolean pressed = false;
	
	public TouchSensorThread(BTOutputWriter dos, TouchSensor sensor, int portNumber) {
	...
	public String perceive() {
		...
		return "touching(" + portNumber + "," + pressed + ")";
	}
