...
public class SoundSensorThread extends SensorThread {

	SoundSensor sensor;
	int[] lastValues = new int[10];
	int arrayPlace = 0;
	
	public SoundSensorThread(BTOutputWriter dos, SoundSensor sensor, int portNumber) {
	...
	public String perceive() {
		...
		if(result > -1) {
			return "sound(" + portNumber + "," + result + ")";
		}
		return null;
	}
